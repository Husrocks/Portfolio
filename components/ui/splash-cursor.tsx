  ...
  useEffect(() => {
    ...
    function getSupportedFormat(
      ...
      if (!supportRenderTextureFormat(internalFormat, format, type)) {
        switch (internalFormat) {
          case 0x822d: // R16F
            return getSupportedFormat(0x822f, 0x8227, type) // RG16F, RG
          case 0x822f: // RG16F
            return getSupportedFormat(0x881a, gl.RGBA, type) // RGBA16F
          default:
            return null
        }
      }
    ...
    function updateColors(dt: number) {
      ...
      if (colorUpdateTimer >= 1) {
        ...
        pointersRef.current.forEach((p: any) => {
    ...
    function generateColor() {
      // Convert #0ebab1 to RGB and normalize
      return {
        r: (0x6f / 255) * 0.15,
        g: (0xff / 255) * 0.15,
        b: (0xe9 / 255) * 0.15,
    ...
    const animate = () => {
      ...
      if (isMouseDown) {
        ...
        const gradient = ctx.createRadialGradient(mouseX, mouseY, 0, mouseX, mouseY, SPLAT_RADIUS * 100)
        gradient.addColorStop(0, `rgba(111, 255, 233, 0.3)`)
        gradient.addColorStop(1, `rgba(111, 255, 233, 0)`)
